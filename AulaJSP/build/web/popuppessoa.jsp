                ...
                try {
                    ...
                    if (numPaginas > 1) { //exibe a paginação
                        ...
                        if (pagina > 1) {
                            ...
                            out.println("<a href='popuppessoa.jsp?busca=$busca&pagina=" + anterior + "'> << Anterior</a> ");
                        }
                        for (int i = 1; i < numPaginas + 1; i++) {
                            if (i == pagina) {
                                out.println(" <b>" + i + "</b> ");
                            } else {
                                out.println("<a href='popuppessoa.jsp?busca=" + busca + "&pagina=" + i + "'>" + i + "</a> ");
                            }
                        }
                        if (pagina < numPaginas) {
                            int proxima = pagina + 1;
                            out.println("<a href='popuppessoa.jsp?busca=" + busca + "&pagina=" + proxima + "'> Próxima >></a> ");
                        }
                        out.println("</center>");
                    }
