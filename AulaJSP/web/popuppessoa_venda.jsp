...
<html> 
    ...
    <head>
        ...
        <script type="text/javascript"> //função javascript que retornará o codigo 
            ...
            {
                window.opener.document.fVenda.pessoa_id.value = id;
                ...
                window.opener.document.fVenda.pessoa_nome.value = nome;
            ...
            <%
                try {
                    ...
                    while (rs.next()) {
                        ...
                        out.println("<tr><td><a href=\"javascript:retorna('" + rs.getString("id") + "', '" + nome + "')\">" + rs.getString("id") + "</a></td>");
                        out.println("<td><a href=\"javascript:retorna('" + rs.getString("id") + "', '" + nome + "')\">" + rs.getString("nome") + "</a></td></tr>");
                        cont++;
                    }
                    ...
                    if (numPaginas > 1) { //exibe a paginação
                        ...
                        if (pagina > 1) {
                            ...
                            out.println("<a href='popuppessoa_venda.jsp?busca=$busca&pagina=" + anterior + "'> << Anterior</a> ");
                        }
                        for (int i = 1; i < numPaginas + 1; i++) {
                            if (i == pagina) {
                                out.println(" <b>" + i + "</b> ");
                            } else {
                                out.println("<a href='popuppessoa_venda.jsp?busca=" + busca + "&pagina=" + i + "'>" + i + "</a> ");
                            }
                        }
                        if (pagina < numPaginas) {
                            int proxima = pagina + 1;
                            out.println("<a href='popuppessoa_venda.jsp?busca=" + busca + "&pagina=" + proxima + "'> Próxima >></a> ");
                        }
                        out.println("</center>");
                    }
